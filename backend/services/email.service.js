...
const sendPasswordResetOTPEmail = async (collegeEmail, otp) => {
  await transporter.sendMail({
    from: `"Training & Placement Office" <${process.env.EMAIL_USER}>`,
    to: collegeEmail,
    subject: "Reset Your Password - TPO Portal",
    html: `
<div style="font-family: Arial, sans-serif; max-width:600px; margin:auto; padding:20px; border:1px solid #ddd; border-radius:8px;">
  ...
  <p>
    We received a request to reset your <strong>TPO Portal</strong> password.
