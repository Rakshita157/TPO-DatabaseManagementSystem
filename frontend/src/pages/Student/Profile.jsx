        ...
        <section className="quick-stats">
          ...
          <div className="stat-card">
            ...
            <div className="stat-content">
              ...
              <span className="stat-value">{profile.profileStatus === 'COMPLETE' ? '100%' : 'Incomplete'}</span>
            </div>
          </div>
        </section>
            ...
            <div className="info-card-body">
              ...
              <div className="info-grid-four">
                ...
                <div className="info-grid-item">
                  ...
                  <span className="info-value">{profile.activeBacklogs + profile.passiveBacklogs}</span>
                </div>
              </div>
              ...
              <div className={`expanded-content ${expanded.address ? 'show' : ''}`}>
                ...
                {profile.linkedinUrl && (
                  <div className="info-row">
                    ...
                    <span className="info-value">{profile.linkedinUrl}</span>
                  </div>
                )}
              </div>
            </div>
